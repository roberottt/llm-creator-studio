"""Genera la seccion 'El codigo completo' de cada SOLUCION.md a partir de la referencia."""
...
AUXILIARES = {
    "01_entorno": ["matmul_flops"],
    "03_tokenizacion": ["_encode_chunk"],
    "09_posicion": ["rotate_half"],
}
...
IMPORTS = {
    "06_atencion": "from typing import Any",
    "10_el_gpt_completo": "from llmfs.reference import make_ffn, make_norm, sinusoidal_embeddings",
}
