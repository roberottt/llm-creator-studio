...
measure_matmul_tflops = resolve("01_entorno", "measure_matmul_tflops")
transformer_flops_per_token = resolve("01_entorno", "transformer_flops_per_token")
estimate_tokens_per_second = resolve("01_entorno", "estimate_tokens_per_second")
