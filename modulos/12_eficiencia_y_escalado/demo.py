...
model_flops_per_token = resolve("12_eficiencia_y_escalado", "model_flops_per_token")
compute_mfu = resolve("12_eficiencia_y_escalado", "compute_mfu")
chinchilla = resolve("12_eficiencia_y_escalado", "chinchilla_optimal_allocation")
...
def main() -> None:
    ...
    fig.tight_layout()
    destino = figures_dir() / "12_eficiencia_y_escalado.png"
