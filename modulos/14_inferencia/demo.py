...
apply_repetition_penalty = resolve("14_inferencia", "apply_repetition_penalty")
top_k_filter = resolve("14_inferencia", "top_k_filter")
top_p_filter = resolve("14_inferencia", "top_p_filter")
KVCache = resolve("14_inferencia", "KVCache")
...
def main() -> None:
    ...
    fig.tight_layout()
    destino = figures_dir() / "14_inferencia.png"
